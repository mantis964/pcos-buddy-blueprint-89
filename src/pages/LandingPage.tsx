        ...
        <div className="pcos-container">
          <div className="text-center max-w-3xl mx-auto mb-10">
            <h2 className="text-2xl md:text-3xl font-display font-semibold mb-6 text-blue-dark">
              About Ecolve Technologies
            </h2>
            <p className="text-lg text-muted-foreground">
              Ecolve is a women-focused wellness tech company redefining how chronic conditions 
              like PCOS are understood, tracked, and treated. We use smart technology, real-world 
              insights, and holistic care models to build tools that actually work.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="pcos-card flex flex-col h-full">
            ...
            <p className="text-muted-foreground mb-6 flex-grow">
              A comprehensive companion app to help women track symptoms, get personalized 
          ...
          <div className="pcos-card flex flex-col h-full bg-blue/5 border-blue/20">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="font-display text-xl font-semibold text-blue-dark">Coming Soon</h3>
            </div>
            <p className="text-muted-foreground mb-6 flex-grow">
              Fertility Tracker, Hormonal Skincare, and More. We're expanding into adjacent 
              areas — all with the same commitment to real, evidence-based care.
            </p>
            <Button variant="outline" className="border-blue text-blue-dark hover:bg-blue/10 w-fit">
              Get Notified
            </Button>
          </div>
        </div>
        ...
        <div className="pcos-container">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              We're building solutions for the problems that have been overlooked for too long.
            </p>
          </div>
        ...
        <div className="pcos-container">
          <div className="text-center max-w-xl mx-auto">
            ...
            <p className="text-muted-foreground mb-8">
              Be the first to know about product launches, beta invites, and health resources.
            </p>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
              <Input 
                ...
                required
              />
              <Button type="submit" className="bg-lavender hover:bg-lavender-dark text-white">
                Subscribe
              </Button>
            </form>
          </div>
