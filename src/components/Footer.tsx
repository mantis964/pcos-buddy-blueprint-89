      ...
      <div className="pcos-container">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-6">
          <div className="flex items-center gap-2">
            ...
            <span className="font-display font-medium text-sm text-lavender-dark">
              OtoVee
            </span>
          </div>
        ...
        <div className="border-t border-lavender/10 pt-6 flex flex-col md:flex-row justify-between items-center">
          <div className="text-xs text-muted-foreground mb-4 md:mb-0">
            © {new Date().getFullYear()} OtoVee. All rights reserved.
          </div>

          <div className="flex gap-6">
            <Link
              to="/terms"
              className="text-xs text-muted-foreground hover:text-lavender-dark transition-colors"
            >
              Terms & Privacy
            </Link>
            <a
